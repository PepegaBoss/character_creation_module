...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'healer':
        return (
            f'{char_name} нанёс урон противнику равны  '
            f'{5 + randint(-3, -1)}')
    return (f'{char_name} Не нанёс урон противнику')


def defence(char_name: str, char_class: str) -> str:
    """Расчитываем блокирование урона класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Расчитываем урон от специального умения класса."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Начинает тренеровку персонажа в игре."""
    if char_class == 'warrior':
